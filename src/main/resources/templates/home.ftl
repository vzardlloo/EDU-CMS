...
<head>
    ...
    <!-- bootstrap -->
    <link href="/css/main/bootstrap/bootstrap.css" rel="stylesheet">
    <link href="/css/main/bootstrap/bootstrap-overrides.css" rel="stylesheet">

    <!-- libraries -->
    <link href="/css/main/lib/jquery-ui-1.10.2.custom.css" rel="stylesheet" type="text/css">
    <link href="/css/main/lib/font-awesome.css" type="text/css" rel="stylesheet">

    <!-- global styles -->
    <link rel="stylesheet" type="text/css" href="/css/main/compiled/layout.css">
    <link rel="stylesheet" type="text/css" href="/css/main/compiled/elements.css">
    <link rel="stylesheet" type="text/css" href="/css/main/compiled/icons.css">

    <!-- this page specific styles -->
    <link rel="stylesheet" href="/css/main/compiled/index.css">
...
<header class="navbar navbar-inverse" role="banner">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.html"><img src="img/main/logo.png"></a>
    </div>
        ...
        <li class="notification-dropdown hidden-xs hidden-sm">
            ...
            <div class="pop-dialog">
                ...
                <div class="body">
                    ...
                    <div class="messages">
                        <a href="#" class="item">
                            <img src="/img/main/contact-img.png" class="display" />
                        ...
                        <a href="#" class="item">
                            <img src="img/main/contact-img2.png" class="display" />
...
<div class="content">
    ...
    <div class="skins-nav">
        ...
        <a href="#" class="skin second_nav" data-file="/css/main/compiled/skins/dark.css">
...
<!-- Latest compiled and minified Locales -->
    ...
    <script src="/js/main/jquery-ui-1.10.2.custom.min.js"></script>
    <!-- knob -->
    ...
    <script type="text/javascript">
        ...
        function test() {
            $.ajax({
                type: "GET",
                url: "http://localhost:8009/student/0001",
                dataType: "json",
                success: function (data) {

                    $("#test").html(data.data.name)
                    $("#test2").html(data.data.password)
                    $("#test3").html(data.data.address)
